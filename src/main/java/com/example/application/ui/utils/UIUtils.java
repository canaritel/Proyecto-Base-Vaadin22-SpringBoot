package com.example.application.ui.utils;
...
import com.example.application.ui.utils.css.AlignSelf;
import com.example.application.ui.utils.css.BorderRadius;
import com.example.application.ui.utils.css.BoxSizing;
import com.example.application.ui.utils.css.PointerEvents;
import com.example.application.ui.utils.css.Shadow;
import com.example.application.ui.utils.css.TextAlign;
import com.example.application.ui.utils.css.TextOverflow;
import com.example.application.ui.utils.css.WhiteSpace;
...
public class UIUtils {
    ...
    private static final ThreadLocal<DecimalFormat> decimalFormat = ThreadLocal
            .withInitial(() -> new DecimalFormat("######.00", DecimalFormatSymbols.getInstance(new Locale("es"))));
